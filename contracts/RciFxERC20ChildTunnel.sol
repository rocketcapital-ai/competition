...
import {FxBaseChildTunnel} from "0xPolygon/fx-portal@1.0.5/contracts/tunnel/FxBaseChildTunnel.sol";
import {IFxERC20} from "0xPolygon/fx-portal@1.0.5/contracts/tokens/IFxERC20.sol";

/**
 * @title FxERC20ChildTunnel
 */
contract RciFxERC20ChildTunnel is FxBaseChildTunnel {
    ...
    constructor(address _fxChild, address _tokenAddress) FxBaseChildTunnel(_fxChild) {
        ...
        require(_isContract(_tokenAddress), "Token template is not contract");
    }
